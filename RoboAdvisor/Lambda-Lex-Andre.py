...
def validate_data(age, investment_amount, intent_request):
    ...
    if age is not None:
        ...
        if age < 0:
            return build_validation_result(False,'age','You need to be older than 0 years old')
        elif age >= 65:
            return build_validation_result(False,'age','You need to be younger than 65 years old')
    ...
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(False,'investmentAmount','You need to invest more than $5,000.00')
